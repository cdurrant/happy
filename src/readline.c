...
void
uncomment( char *string ) /* truncates string at the first ! */
{
...
int
read_line( FILE *file, char *string ) {
  int	c;
  int	i=0;
...
int 
not_blank( char *string ) /* checks whether string is full of white space */
{
  while ( *string != 0 ) {
...
int 
skip_comments( FILE *file, char *string ) { 
  int n = EOF;
